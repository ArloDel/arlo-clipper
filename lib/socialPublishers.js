...
/**
 * Helper to get publishing status and direct video links for a clip
 */
...
/**
 * Format timestamp into Indonesian locale date & time string
 */
...
/**
 * Check if a clip has already been published to the specified platform(s)
 * Returns duplicate warning metadata and formatted message if already uploaded
 */
