    ...
    for (const targetVideo of newVideosToProcess) {
      ...
      try {
        ...
        const record = addProcessedVideo({
          ...
          clips: exportResult ? exportResult.exportedClips : pipelineResult.clips || [],
        ...
        addBotLog({
          level: 'success',
          message: `Successfully processed "${targetVideo.title}" → Generated ${record.clipCount} clips & social metadata.`,
          details: {
            videoId: targetVideo.videoId,
